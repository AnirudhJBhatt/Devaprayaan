...
<body>
  ...
  <section class="text-white text-center d-flex align-items-center justify-content-center" 
    ...
    <div class="position-relative z-1">
      <h1 class="fw-bold" data-aos="fade-up"><?php echo $package['title']; ?></h1>
      <p data-aos="fade-up" data-aos-delay="200">
        <i class="fas fa-map-marker-alt"></i> <?php echo $package['location']; ?> | 
        <i class="far fa-clock"></i> <?php echo $package['duration']; ?>
      </p>
      <h3 class="mt-3 text-warning" data-aos="zoom-in">From Rs <?php echo $package['price']; ?></h3>
    </div>
  </section>
      ...
      <div class="col-lg-10 mx-auto" data-aos="fade-up">
        ...
        <ul class="list-unstyled">
          <?php foreach($package['highlights'] as $point): ?>
            <li><i class="fas fa-check-circle text-success"></i> <?php echo $point; ?></li>
          <?php endforeach; ?>
        </ul>
        ...
        <div class="accordion" id="itineraryAccordion">
          <div class="accordion-item">
            ...
            <div id="day1" class="accordion-collapse collapse show" data-bs-parent="#itineraryAccordion">
              <div class="accordion-body">Welcome to your destination! Airport pickup and guided city sightseeing.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header">
